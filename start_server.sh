...
torchserve --start --ncs --disable-token-auth --ts-config config.properties --model-store model_store --models whisperx_asr=whisperx_asr.mar
#torchserve --start --ncs --disable-token-auth --ts-config config.properties --model-store model_store --models my_asr=my_asr.mar
